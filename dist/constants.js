 ...
 */
export const DEFAULT_SECURITY_LEVEL = 'standard';
/**
 * Default scrypt parameters (standard security)
 */
export const DEFAULT_SCRYPT_PARAMS = SCRYPT_PRESETS[DEFAULT_SECURITY_LEVEL];
/**
 ...
 */
export const SUPPORTED_ALGORITHMS = ['scrypt'];
